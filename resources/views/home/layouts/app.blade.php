...
<head>
   ...
   ================================================== -->
    ...
    <!-- script
   ================================================== -->
    <script src="{{ asset('guest/js/modernizr.js') }}"></script>
    <script src="{{ asset('guest/js/pace.min.js') }}"></script>
	<!-- summernote -->
 ...
 ================================================== -->
    ...
    <link rel="icon" href="{{ asset('guest/favicon.ico') }}" type="image/x-icon">
...
<body id="top">
        ...
        <div class="row header-content">
            ...
            <div class="logo" style="display: inline-flex">
                ...
                <div class="d-inline-flex">
                    <h1 style="margin-left: 20px; margin-top: 10px">Portal Berita</h1>
                </div>
            </div>
   ...
   ================================================== -->
    ...
    <!-- Java Script
   ================================================== -->
    <script src="{{ asset('guest/js/jquery-2.1.3.min.js') }}"></script>
