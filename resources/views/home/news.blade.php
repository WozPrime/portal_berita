                ...
                <article class="format-standard">
                    ...
                    <div class="content-media">
                        <div class="post-thumb" style="text-align: center">
                            <img src="{{ url('thumbnail/' . $post->thumbnail) }}">
                        </div>
                    </div>

                    <div class="primary-content">

                        <h1 class="page-title">{{ $post->judul }}</h1>

                        <ul class="entry-meta">
                            <li class="date">{{ $post->updated_at->format('M d, Y') }}</li>
                            <li class="cat">
                                @foreach ($tags as $tag)
                        ...
                        <div class="author-profile">
                            <img src="{{asset('dist/img/user_default.jpg')}}" alt="">

                            <div class="about">
                                <h6>Posted by</h6>
                                <h4><a href="#">{{ $post->uploader }}</a></h4>
